...
void test_nxinit_service_args_max_boundary(FAR void **state)
{
  ...
  char at_limit[] = "service foo1 /bin/foo arg1 arg2 arg3 arg4 arg5";
  char over_limit[] =
    "service foo2 /bin/foo arg1 arg2 arg3 arg4 arg5 arg6";
  FAR struct service_s *s;

  service_manager_init(&sm);

  /* "service" + "foo1" + "/bin/foo" + 5 args = 8 tokens, matching the
   * default CONFIG_SYSTEM_NXINIT_SERVICE_ARGS_MAX exactly.
   */
